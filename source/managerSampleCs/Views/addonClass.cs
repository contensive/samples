    ...
    public class addonClass : Contensive.BaseClasses.AddonBaseClass
    {
        ...
        public override object Execute(Contensive.BaseClasses.CPBaseClass cp)
        {
            ...
            try
            {
                ...
                page.navLink = "?" + cp.Utils.ModifyQueryString(rqs, constants.rnDstFormId, "0", true);
                //
                page.addNav();
                page.navCaption = "Blank Form";
                page.navLink = "?" + cp.Utils.ModifyQueryString(rqs, constants.rnDstFormId, constants.formIdBlank.ToString(), true);
                //
                switch (dstFormId)
                {
                    case (constants.formIdBlank):
