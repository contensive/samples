    ...
    namespace Models {
        public abstract class baseModel {
            ...
            protected static void delete<T>(CPBaseClass cp, int recordId) where T : baseModel {
                deleteList<T>(cp, "(id=" + recordId.ToString() + ")");
            }
            //
            //====================================================================================================
            /// <summary>
            ...
            protected static void delete<T>(CPBaseClass cp, string ccguid) where T : baseModel {
                deleteList<T>(cp, "(ccguid=" + cp.Db.EncodeSQLText(ccguid) + ")");
            }
            //
            //====================================================================================================
            /// <summary>
            ...
            protected static void deleteList<T>(CPBaseClass cp, string sqlCriteria) where T : baseModel {
                try {
